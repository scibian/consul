# Debug packages cannot be generated when using a splitted consul
# binary as a source. Until a fix is found debug packages build is disabled.
...
%changelog
* Thu Sep 10 2020 Pierre Trespeuch <pierre-externe.trespeuch@edf.fr> 1.8.3-1.el8_1.edf
- Adapt packaging to rhel >=8
- Bump version to 1.8.3

* Thu May 09 2019 Igor Krutyakov <lebriquet@gmail.com>
